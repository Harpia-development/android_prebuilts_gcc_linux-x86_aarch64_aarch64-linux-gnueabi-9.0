...
enum opt_code
{
  ...
  OPT_mstrict_align = 1286,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1287,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1288,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1289,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1290,             /* -mtrack-speculation */
  OPT_mtune_ = 1291,                         /* -mtune= */
  OPT_muclibc = 1292,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1293,             /* -mverbose-cost-dump */
  OPT_n = 1294,                              /* -n */
  OPT_no_canonical_prefixes = 1295,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1296,              /* -no-integrated-cpp */
  OPT_no_pie = 1297,                         /* -no-pie */
  OPT_nocpp = 1298,                          /* -nocpp */
  OPT_nodefaultlibs = 1299,                  /* -nodefaultlibs */
  OPT_nolibc = 1300,                         /* -nolibc */
  OPT_nophoboslib = 1301,                    /* -nophoboslib */
  OPT_nostartfiles = 1302,                   /* -nostartfiles */
  OPT_nostdinc = 1303,                       /* -nostdinc */
  OPT_nostdinc__ = 1304,                     /* -nostdinc++ */
  OPT_nostdlib = 1305,                       /* -nostdlib */
  OPT_o = 1306,                              /* -o */
  OPT_p = 1307,                              /* -p */
  OPT_pass_exit_codes = 1308,                /* -pass-exit-codes */
  /* OPT_pedantic = 1309, */                 /* -pedantic */
  OPT_pedantic_errors = 1310,                /* -pedantic-errors */
  OPT_pg = 1311,                             /* -pg */
  OPT_pie = 1312,                            /* -pie */
  OPT_pipe = 1313,                           /* -pipe */
  OPT_posix = 1314,                          /* -posix */
  ...
  OPT_profile = 1326,                        /* -profile */
  OPT_pthread = 1327,                        /* -pthread */
  OPT_quiet = 1328,                          /* -quiet */
  OPT_r = 1329,                              /* -r */
  OPT_rdynamic = 1330,                       /* -rdynamic */
  OPT_remap = 1331,                          /* -remap */
  OPT_s = 1332,                              /* -s */
  OPT_save_temps = 1333,                     /* -save-temps */
  OPT_save_temps_ = 1334,                    /* -save-temps= */
  OPT_shared = 1335,                         /* -shared */
  OPT_shared_libgcc = 1336,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1337,               /* -shared-libphobos */
  ...
  OPT_static_libphobos = 1348,               /* -static-libphobos */
  OPT_static_libstdc__ = 1349,               /* -static-libstdc++ */
  OPT_static_libtsan = 1350,                 /* -static-libtsan */
  OPT_static_libubsan = 1351,                /* -static-libubsan */
  OPT_static_pie = 1352,                     /* -static-pie */
  /* OPT_std_c__03 = 1353, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1354, */                /* -std=c++0x */
  OPT_std_c__11 = 1355,                      /* -std=c++11 */
  OPT_std_c__14 = 1356,                      /* -std=c++14 */
  OPT_std_c__17 = 1357,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1358, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1359, */                /* -std=c++1z */
  OPT_std_c__2a = 1360,                      /* -std=c++2a */
  OPT_std_c__98 = 1361,                      /* -std=c++98 */
  OPT_std_c11 = 1362,                        /* -std=c11 */
  OPT_std_c17 = 1363,                        /* -std=c17 */
  /* OPT_std_c18 = 1364, */                  /* -std=c18 */
  /* OPT_std_c1x = 1365, */                  /* -std=c1x */
  OPT_std_c2x = 1366,                        /* -std=c2x */
  ...
  OPT_std_gnu__2a = 1384,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1385,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1386,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1387,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1388, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1389, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1390,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1391, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1392,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1393,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1394, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1395, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1396,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1397, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1398, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1399, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1400, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1401, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1402,                     /* -std=legacy */
  OPT_symbolic = 1403,                       /* -symbolic */
  OPT_t = 1404,                              /* -t */
  OPT_time = 1405,                           /* -time */
  OPT_time_ = 1406,                          /* -time= */
  OPT_traditional = 1407,                    /* -traditional */
  OPT_traditional_cpp = 1408,                /* -traditional-cpp */
  OPT_trigraphs = 1409,                      /* -trigraphs */
  OPT_u = 1410,                              /* -u */
  OPT_undef = 1411,                          /* -undef */
  OPT_v = 1412,                              /* -v */
  OPT_version = 1413,                        /* -version */
  OPT_w = 1414,                              /* -w */
  OPT_wrapper = 1415,                        /* -wrapper */
  OPT_x = 1416,                              /* -x */
  OPT_z = 1417,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
